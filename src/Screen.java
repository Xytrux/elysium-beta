...
public class Screen extends JPanel implements KeyListener, MouseListener, MouseMotionListener, MouseWheelListener{
	...
	public void paintComponent(Graphics g)
	{
		...
		g.fillRect(0, 0, (int)DDD.ScreenSize.getWidth(), (int)DDD.ScreenSize.getHeight());
...
//		System.out.println(repaintTime);
	...
	void drawMouseAim(Graphics g)
	{
		...
		g.drawLine((int)(DDD.ScreenSize.getWidth()/2 - aimSight), (int)(DDD.ScreenSize.getHeight()/2), (int)(DDD.ScreenSize.getWidth()/2 + aimSight), (int)(DDD.ScreenSize.getHeight()/2));
		g.drawLine((int)(DDD.ScreenSize.getWidth()/2), (int)(DDD.ScreenSize.getHeight()/2 - aimSight), (int)(DDD.ScreenSize.getWidth()/2), (int)(DDD.ScreenSize.getHeight()/2 + aimSight));			
	}
	...
	{		
			double difX = (NewMouseX - DDD.ScreenSize.getWidth()/2);
			double difY = (NewMouseY - DDD.ScreenSize.getHeight()/2);
	...
	void CenterMouse() 
	{
			try {
				r = new Robot();
				r.mouseMove((int)DDD.ScreenSize.getWidth()/2, (int)DDD.ScreenSize.getHeight()/2);
